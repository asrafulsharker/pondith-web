                ...
                <div className="col-md-4 div-left-signup mr-auto">
                    ...
                    <div className="row ">
                        ...
                        <p style={{fontSize:"10px",color:"red"}}>{emailError} {passwordError}</p>
                            ...
                            <>
                            <button style={{width:"100%"}} className=" login-box btn-submit" onClick={handleSignup} type="submit"><Link style={{textDecoration:"none",color:"white"}} to="/course-home">Sign Up</Link></button>
                            </>
